...
pop <- append(pop, c("offen", "criminal", "burgalry", "robbery"))
int <- append(int, c("residential", "commercial", "street", "decision-making", "predict locations", "future crime"))
...
retrieved_articles <-  litsearchr::import_results(directory="./new2")
...
write.csv(df_articles_found, "2024_articles_found.csv", )
