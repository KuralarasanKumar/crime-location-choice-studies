...
grouped_terms <- read.csv(here::here("./20250513_Analysis & Results/output_spatial_scale/20250513_grouped_search_term.csv"))
grouped_terms
...
# One-liner with anonymous function
custom_save(Unique_retrieved_articles, output_spatial_scale, "Unique_retrieved_articles.csv", 
            function(x, file, ...) write.csv(x, file = file, fileEncoding = "UTF-8", row.names = FALSE, quote = TRUE, ...))
